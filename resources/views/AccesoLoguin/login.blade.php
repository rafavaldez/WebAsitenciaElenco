...
<html lang="en">
    <head>
        ...
        <link href=" {{ asset('recursoslogui/css/bootstrap.min.css')}}" rel="stylesheet">

        <link href="{{ asset('recursoslogui/css/bootstrap-icons.css')}}" rel="stylesheet">

        <link href="{{ asset('recursoslogui/css/tooplate-kool-form-pack.css')}}" rel="stylesheet">
<!--
                ...
                <div class="container">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-lg-12 col-12 d-flex">
                            <a class="site-header-text d-flex justify-content-center align-items-center me-auto" href="{{route('login')}}">
                                <i class="bi-box"></i>
            ...
            <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenuLabel">                
                ...
                <div class="offcanvas-body d-flex flex-column justify-content-center align-items-center">
                    <nav>
                        <ul>
                            <li>
                                <a class="active" href="{{route('login_acceso')}}">Login Form</a>
                            </li>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-12 mx-auto">
                            <form id="login-form" class="custom-form login-form" role="form" method="post">
                                @csrf
...
<script>
    ...
    $('#login-form').submit(function(event) {
        ...
        $.ajax({
            url: '{{ route("loginvalidacion") }}', // Reemplaza 'login' con el nombre de la ruta de tu controlador
            method: 'POST',
            data: formData,
            success: function(response) {
                // Verifica si la respuesta indica credenciales válidas
                if (response.message === 'Credenciales válidas') {
                    // Redirige al usuario a la página de Dashboard
                    window.location.href = '{{ route("dashboard_index") }}';
                } else {
                    // Maneja otros casos de respuesta aquí si es necesario
            ...
            error: function(xhr, status, error) {
                ...
                <div class="video-wrap">
                    <video autoplay="" loop="" muted="" class="custom-video" poster="">
                        <source src="{{ asset('recursoslogui/videos/video.mp4')}}" type="video/mp4">
        ...
        <script src="{{ asset('recursoslogui/js/countdown.js')}}"></script>
        <script src="{{ asset('recursoslogui/js/init.js')}}"></script>
